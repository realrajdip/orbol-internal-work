...
const Service = () => {
  const data = [{ title: "Theartrical" }, { title: "Mangazine" }, { title: "Branded Kiosk" }, { title: "Voucher Distribution" },{ title: "Flight Ticket" }, {title: "Commercial Video Ad"}, { title: "Commercial Visual Photo Ad" }];
